...
defined('JWT_SECRET_KEY')      OR define('JWT_SECRET_KEY', '44f7f748525c67a3b4c1c4a233ff0206'); // jwt token secret
defined('UPLOAD_PATH')         OR define('UPLOAD_PATH', 'public/upload/'); // file upload path
defined('UPLOAD_VEHICLE_PATH') OR define('UPLOAD_VEHICLE_PATH', UPLOAD_PATH . 'vehicle'); // file upload path - vehicle
defined('UPLOAD_USER_PATH')    OR define('UPLOAD_USER_PATH', UPLOAD_PATH . 'users'); // file upload path - user
